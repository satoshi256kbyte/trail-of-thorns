...
export const ObjectiveTypeSchema = z.enum(['defeat', 'collect', 'reach', 'survive']);
...
export const ItemSchema = z.object({
    ...
    name: z.string().min(1, 'Item name is required').max(50, 'Item name too long'),
    description: z.string().max(500, 'Description too long'),
    type: ItemTypeSchema,
    rarity: RaritySchema,
...
export const StageSchema = z.object({
    ...
    name: z.string().min(1, 'Stage name is required').max(50, 'Stage name too long'),
    description: z.string().max(500, 'Description too long'),
    size: z.object({
