...
describe('RecruitmentDataValidator', () => {
  ...
  describe('validateStageRecruitmentConsistency', () => {
    test('should validate consistent stage and character data', () => {
      ...
      const stage = {
        id: 'stage-001',
        playerUnits: [{ characterId: 'protagonist', startPosition: { x: 1, y: 4 } }],
        enemyUnits: [{ characterId: 'enemy_knight', startPosition: { x: 8, y: 4 } }],
    ...
    test('should throw error for unknown character reference', () => {
      const characters = [{ id: 'protagonist', isRecruitable: false }];

      const stage = {
        id: 'stage-001',
        playerUnits: [{ characterId: 'unknown_character', startPosition: { x: 1, y: 4 } }],
        enemyUnits: [],
        recruitableCharacters: [],
      };
    ...
    test('should throw error for non-recruitable character listed as recruitable', () => {
      const characters = [{ id: 'enemy_knight', isRecruitable: false }];
