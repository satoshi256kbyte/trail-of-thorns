...
describe('GameplayScene Performance Tests', () => {
  ...
  describe('Stress Testing', () => {
    ...
    test('should recover from performance spikes', async () => {
      ...
      expect(recoveryMetrics.averageUpdateTime).toBeLessThan(
        baselineMetrics.averageUpdateTime * 1.5
      );
    });
  });
  ...
  describe('Performance Regression Detection', () => {
    test('should detect performance regressions in update loop', async () => {
      ...
      expect(baselineMetrics.averageUpdateTime).toBeLessThan(
        performanceThresholds.maxAverageUpdateTime
      );
