...
import {
  ...
  TransitionType,
  SceneData,
} from '../../../game/src/utils/SceneTransition';
...
describe('SceneTransition', () => {
  ...
  describe('transitionTo', () => {
    ...
    it('should handle transition errors gracefully', async () => {
      ...
      // Act & Assert
      await expect(SceneTransition.transitionTo(mockScene, 'TitleScene')).rejects.toThrow(
        'Camera error'
      );

      expect(consoleSpy).toHaveBeenCalledWith('Error during scene transition:', expect.any(Error));
  ...
  describe('validateSceneKey', () => {
    ...
    it('should handle validation errors gracefully', () => {
      ...
      // Assert
      expect(result).toBe(false);
      expect(consoleSpy).toHaveBeenCalledWith('Error validating scene key:', expect.any(Error));
  ...
  describe('getAvailableScenes', () => {
    ...
    it('should handle errors gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Error getting available scenes:', expect.any(Error));
  ...
  describe('transition timing requirements', () => {
    ...
    it('should respect custom duration settings', async () => {
      ...
      // Act
      await SceneTransition.transitionTo(mockScene, 'TitleScene', TransitionType.FADE, undefined, {
