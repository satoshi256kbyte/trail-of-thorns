import { DataLoader, DataValidationError, StageData, ConfigData } from '../../../game/src/utils/DataLoader';
...
describe('DataLoader', () => {
    ...
    describe('loadConfigData', () => {
        ...
        it('should throw error when fetch fails', async () => {
            ...
            await expect(DataLoader.loadConfigData()).rejects.toThrow('Failed to load config.json: 500 Internal Server Error');
        });
