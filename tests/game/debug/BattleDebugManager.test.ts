import {
  ...
  BattleDebugInfo,
  DebugDisplayOptions,
} from '../../../game/src/debug/BattleDebugManager';
...
describe('BattleDebugManager', () => {
  ...
  beforeEach(() => {
    ...
    mockBattleResult = {
      ...
      baseDamage: 40,
      finalDamage: 45,
      modifiers: [{ type: 'elemental', multiplier: 1.1, description: 'Fire vs Ice' }],
      isCritical: false,
      isEvaded: false,
      experienceGained: 15,
  ...
  describe('Debug Logging', () => {
    ...
    test('should log battle phase end with calculations', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('damage_calculation'));
