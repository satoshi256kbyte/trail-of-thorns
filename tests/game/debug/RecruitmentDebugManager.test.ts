...
describe('RecruitmentDebugManager', () => {
  ...
  describe('Condition Evaluation Logging', () => {
    it('should log condition evaluation', () => {
      debugManager.logConditionEvaluation(mockCondition, mockContext, true, 5, undefined);
    ...
    it('should log condition evaluation with error', () => {
      ...
      debugManager.logConditionEvaluation(mockCondition, mockContext, false, 10, errorMessage);
  ...
  describe('Recruitment Simulation', () => {
    it('should simulate recruitment successfully', () => {
      ...
      const result = debugManager.simulateRecruitment(mockAttacker, mockTarget, conditions, 50, 1);
  ...
  describe('Edge Cases', () => {
    it('should handle empty conditions array', () => {
      const result = debugManager.simulateRecruitment(mockAttacker, mockTarget, [], 50, 1);
