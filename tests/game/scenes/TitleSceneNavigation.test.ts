...
describe('TitleScene Navigation', () => {
  ...
  describe('Requirements Compliance', () => {
    ...
    test('should satisfy requirement 3.1: Show Config button', () => {
      ...
      const configCall = (MenuButton as jest.Mock).mock.calls.find(call => call[3] === 'Config');
  ...
  describe('Error Handling', () => {
    ...
    test('should handle Game Start transition errors gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Error handling game start:', expect.any(Error));
    ...
    test('should handle Config transition errors gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Error handling config:', expect.any(Error));
  ...
  describe('Cleanup', () => {
    test('should destroy navigation buttons on scene cleanup', () => {
      ...
      const buttonInstances = (MenuButton as jest.Mock).mock.results.map(result => result.value);
