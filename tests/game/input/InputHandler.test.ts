...
import { InputHandler, InputConfig, ClickInfo, KeyboardInfo } from '../../../game/src/input/InputHandler';
...
describe('InputHandler', () => {
    ...
    describe('Edge Cases', () => {
        test('should handle missing keyboard input gracefully', () => {
            ...
            expect(() => new InputHandler(sceneWithoutKeyboard, undefined, mockEventEmitter)).not.toThrow();
        });
