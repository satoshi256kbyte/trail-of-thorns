...
describe('AIController Recruitment System Integration', () => {
  ...
  beforeEach(() => {
    ...
    // Create systems
    npcStateManager = new NPCStateManager(mockScene as any, undefined, mockEventEmitter as any);

    recruitmentSystem = new RecruitmentSystem(mockScene as any, undefined, mockEventEmitter as any);

    aiController = new AIController(mockScene as any, battleSystem, movementSystem, {
  ...
  describe('Error Handling and Edge Cases', () => {
    test('should handle missing NPCStateManager gracefully', async () => {
      ...
      const isolatedAI = new AIController(mockScene as any, battleSystem, movementSystem);
  ...
  describe('Configuration and Customization', () => {
    ...
    test('should allow disabling tactical AI for NPCs', async () => {
      ...
      const simpleAI = new AIController(mockScene as any, battleSystem, movementSystem, {
