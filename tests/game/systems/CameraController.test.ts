...
import { CameraController, CameraConfig, CameraBounds } from '../../../game/src/systems/CameraController';
...
describe('CameraController', () => {
    ...
    describe('Constructor and Initialization', () => {
        ...
        test('should initialize with custom configuration', () => {
            ...
            cameraController = new CameraController(mockScene, testMapData, customConfig, mockEventEmitter);
    ...
    describe('Map Bounds Management', () => {
        ...
        test('should set map bounds correctly', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('camera-bounds-updated', expect.any(Object));
        });
    ...
    describe('Camera Movement', () => {
        ...
        test('should move camera up', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('camera-moved', expect.objectContaining({
                direction: 'up'
            }));
        });
    ...
    describe('Camera Focus', () => {
        ...
        test('should focus immediately with zero duration', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('camera-focused', expect.objectContaining({
                immediate: true
            }));
        });
    ...
    describe('State Management', () => {
        ...
        test('should reset camera', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('camera-reset', expect.objectContaining({
                immediate: true
            }));
        });
    });
    ...
    describe('Configuration Management', () => {
        ...
        test('should update configuration', () => {
            ...
            expect(config.minZoom).toBe(0.3);
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('camera-config-updated', expect.any(Object));
        });
