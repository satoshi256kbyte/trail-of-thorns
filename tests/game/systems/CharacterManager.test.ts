...
import { Unit, Position, StageData, MapData, GameplayError } from '../../../game/src/types/gameplay';
...
describe('CharacterManager', () => {
    ...
    describe('selectCharacter', () => {
        ...
        test('should successfully select a character', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('character-selected', expect.objectContaining({
    ...
    describe('moveCharacter', () => {
        ...
        test('should successfully move character to empty position', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('character-moved', expect.objectContaining({
                character: expect.objectContaining({ id: 'player1' }),
                newPosition: { x: 2, y: 2 }
            }));
        });
    ...
    describe('updateCharacterStats', () => {
        ...
        test('should successfully update character stats', () => {
            ...
            expect(mockEventEmitter.emit).toHaveBeenCalledWith('character-updated', expect.objectContaining({
                character: expect.objectContaining({ id: 'player1' }),
