...
describe('EquipmentManager', () => {
    ...
    describe('getEquipmentDamageModifiers', () => {
        it('should return damage modifiers from equipment', () => {
            ...
            const modifiers = equipmentManager.getEquipmentDamageModifiers(attacker, target, Element.FIRE);
        ...
        it('should include elemental resistance modifiers', () => {
            ...
            const resistanceModifier = modifiers.find(mod => mod.type === 'elemental' && mod.source === 'equipment_resistance');
    ...
    describe('validateEquipment', () => {
        ...
        it('should warn about broken equipment', () => {
            ...
            expect(validation.isValid).toBe(true);
            expect(validation.warnings).toContain('Equipment is broken and will provide reduced benefits');
        });
