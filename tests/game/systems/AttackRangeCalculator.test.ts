...
describe('AttackRangeCalculator', () => {
    ...
    describe('calculateAttackRange', () => {
        ...
        test('should calculate range for spear (line weapon)', () => {
            ...
            const expectedPositions = [
                { x: 5, y: 4 }, { x: 5, y: 3 }, // North
                { x: 6, y: 5 }, { x: 7, y: 5 }, // East
                { x: 5, y: 6 }, { x: 5, y: 7 }, // South
                { x: 4, y: 5 }, { x: 3, y: 5 }, // West
            ];
        ...
        test('should calculate range for staff (cross pattern)', () => {
            ...
            const expectedPositions = [
                { x: 3, y: 5 }, { x: 4, y: 5 }, { x: 6, y: 5 }, { x: 7, y: 5 }, // Horizontal
                { x: 5, y: 3 }, { x: 5, y: 4 }, { x: 5, y: 6 }, { x: 5, y: 7 }, // Vertical
            ];
    ...
    describe('utility methods', () => {
        ...
        test('should check if position is threatened', () => {
            ...
            expect(calculator.isPositionThreatened(threatenedPosition, testUnit, sword, testMapData)).toBe(true);
            expect(calculator.isPositionThreatened(safePosition, testUnit, sword, testMapData)).toBe(false);
        });
