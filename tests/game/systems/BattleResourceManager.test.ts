...
import {
  BattleResourceManager,
  ResourceType,
} from '../../../game/src/systems/BattleResourceManager';
...
describe('BattleResourceManager', () => {
  ...
  describe('Statistics and Monitoring', () => {
    ...
    test('should warn about high resource count', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('High resource count'));
  ...
  describe('Error Handling and Edge Cases', () => {
    test('should handle resources without destroy method', () => {
      ...
      expect(() => {
        const id = resourceManager.registerResource(resourceWithoutDestroy, ResourceType.GRAPHICS);
    ...
    test('should handle event listeners without proper cleanup methods', () => {
      ...
      expect(() => {
        const id = resourceManager.registerEventListener(targetWithoutMethods, 'click', callback);
        resourceManager.unregisterResource(id);
      }).not.toThrow();
    });
