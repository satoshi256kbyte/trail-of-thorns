...
const createMockStageData = (): StageData => ({
  ...
  playerUnits: [createMockUnit({ id: 'player-1', name: 'Hero', faction: 'player' })],
  enemyUnits: [createMockUnit({ id: 'enemy-1', name: 'Orc', faction: 'enemy' })],
...
describe('RecruitmentUI Integration Tests', () => {
  ...
  describe('Integration with RecruitmentSystem', () => {
    test('should display conditions when recruitment system provides them', () => {
      ...
      jest.spyOn(recruitmentSystem, 'getRecruitmentConditions').mockReturnValue(mockConditions);
    ...
    test('should update progress when recruitment system reports progress changes', () => {
      ...
      jest.spyOn(recruitmentSystem, 'getRecruitmentProgress').mockReturnValue(mockProgress);
      ...
      const progressTextCall = textCalls.find(
        call => call[2] === '100%' || (typeof call[2] === 'string' && call[2].includes('%'))
      );
  ...
  describe('Error Handling in Integration', () => {
    test('should handle recruitment system errors gracefully', () => {
      ...
      jest.spyOn(recruitmentSystem, 'getRecruitmentConditions').mockImplementation(() => {
    ...
    test('should handle NPC state manager errors gracefully', () => {
      ...
      jest.spyOn(npcStateManager, 'convertToNPC').mockReturnValue({
        success: false,
