...
import { RecruitmentCondition, RecruitmentContext, RecruitmentConditionType } from '../../../../game/src/types/recruitment';
...
describe('RecruitmentConditionCache Performance', () => {
    ...
    test('should optimize cache performance automatically', () => {
        ...
        expect(optimizedStats.averageAccessTime).toBeLessThanOrEqual(initialStats.averageAccessTime + 1);
    });
});
...
describe('OptimizedNPCStateManager Performance', () => {
    ...
    test('should optimize indexes automatically', () => {
        ...
        expect(afterOptimization.indexFragmentation).toBeLessThanOrEqual(beforeOptimization.indexFragmentation);
    });
...
describe('RecruitmentUIPool Performance', () => {
    ...
    test('should optimize pool sizes automatically', () => {
        ...
        for (let i = 0; i < 100; i++) {
            const objects = [
                uiPool.getConditionPanel(),
                uiPool.getProgressBar(),
                uiPool.getText()
            ];
...
describe('RecruitmentResourceManager Memory Management', () => {
    ...
    test('should detect potential memory leaks', (done) => {
        ...
        for (let i = 0; i < 150; i++) { // Exceeds default threshold of 100
            const mockObject = {
                id: `leak-object-${i}`,
                destroy: jest.fn(),
                active: true,
