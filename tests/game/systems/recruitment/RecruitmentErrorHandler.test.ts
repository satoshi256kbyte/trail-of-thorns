...
import { RecruitmentErrorHandler, RecruitmentErrorRecoveryResult } from '../../../../game/src/systems/recruitment/RecruitmentErrorHandler';
import {
    RecruitmentError,
    RecruitmentContext,
...
describe('RecruitmentErrorHandler', () => {
    ...
    describe('Event Emission', () => {
        test('should emit error handled event', async () => {
            ...
            await handlerWithEmitter.handleRecruitmentError(
                RecruitmentError.INVALID_TARGET,
                mockContext
            );

            expect(mockEmitter.emit).toHaveBeenCalledWith('recruitment-error-handled', expect.objectContaining({
        ...
        test('should emit critical error event on handling failure', async () => {
            ...
            await faultyHandler.handleRecruitmentError(
                RecruitmentError.INVALID_TARGET,
                mockContext
            );

            expect(mockEmitter.emit).toHaveBeenCalledWith('recruitment-critical-error', expect.objectContaining({
...
describe('RecruitmentErrorHandler Integration', () => {
    ...
    test('should work with convenience function', async () => {
        const { handleRecruitmentError } = await import('../../../../game/src/systems/recruitment/RecruitmentErrorHandler');
