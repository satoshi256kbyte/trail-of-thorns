...
describe('DamageCalculator Equipment Integration', () => {
  ...
  describe('equipment bonuses in damage calculation', () => {
    it('should apply attack bonus from equipment to damage calculation', () => {
      ...
      const baseDamageWithEquipment = damageCalculator.calculateBaseDamage(
        attacker,
        target,
        mockWeapon
      );
    ...
    it('should apply speed bonuses to critical hit calculations', () => {
      ...
      const avgCriticalChance =
        criticalResults.reduce((sum, chance) => sum + chance, 0) / criticalResults.length;
    ...
    it('should apply equipment durability effects to weapon performance', () => {
      ...
      const durabilityModifier = calculation.modifiers.find(
        mod => mod.source === 'weapon_durability'
      );
    ...
    it('should handle healing calculations with equipment bonuses', () => {
      ...
      const healingWithEquipment = damageCalculator.calculateHealing(
        attacker,
        target,
        healingStaff
      );
