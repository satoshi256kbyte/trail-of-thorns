                    ...
                    layers: [
                        {
                            name: 'background',
                            type: 'background',
                            data: Array(12).fill(null).map(() => Array(15).fill(1)),
                            visible: true,
                            opacity: 1.0,
                        },
                    ],
                    playerSpawns: [{ x: 2, y: 10 }, { x: 3, y: 10 }],
                    enemySpawns: [{ x: 12, y: 2 }, { x: 13, y: 2 }],
                }),
            },
        },
        events: {
...
const createComprehensiveStageData = (): StageData => ({
    ...
    mapData: {
        ...
        playerSpawns: [{ x: 2, y: 10 }, { x: 3, y: 10 }, { x: 4, y: 10 }],
        enemySpawns: [{ x: 12, y: 2 }, { x: 13, y: 2 }],
    },
    playerUnits: [
        {
...
describe('Enhanced Movement System End-to-End Tests', () => {
    ...
    beforeEach(async () => {
        ...
        scene.getMovementSystem = jest.fn().mockReturnValue({
            ...
            executeMovement: jest.fn().mockResolvedValue({ success: true, finalPosition: { x: 5, y: 8 } }),
    ...
    describe('Complete Tactical Scenarios', () => {
        test('should execute basic movement scenario successfully', async () => {
            ...
            console.log(`Basic Movement Scenario - Success: ${result.success}, Time: ${result.performance.totalTime.toFixed(2)}ms`);
        });
        ...
        test('should execute multi-unit coordination scenario', async () => {
            ...
            console.log(`Multi-Unit Coordination - Success: ${result.success}, Avg Step Time: ${result.performance.averageStepTime.toFixed(2)}ms`);
        });
        ...
        test('should handle error recovery scenario', async () => {
            ...
            mockMovementSystem.executeMovement = jest.fn()
            ...
            console.log(`Error Recovery - Success: ${result.success}, Errors Handled: ${result.stepResults.filter(s => !s.success).length}`);
        });
        ...
        test('should execute keyboard-only navigation scenario', async () => {
            ...
            console.log(`Keyboard Navigation - Success: ${result.success}, All Steps Keyboard: ${result.stepResults.every(s => s.stepType === 'key')}`);
        });
        ...
        test('should execute rapid input scenario', async () => {
            ...
            console.log(`Rapid Input - Success: ${result.success}, Total Time: ${result.performance.totalTime.toFixed(2)}ms`);
        });
    });
    ...
    describe('Complex Tactical Scenarios', () => {
        test('should execute flanking maneuver scenario', async () => {
            ...
            console.log(`Flanking Maneuver - Success: ${result.success}, Tactical Steps: ${result.executedSteps}`);
        });
        ...
        test('should execute defensive formation scenario', async () => {
            ...
            console.log(`Defensive Formation - Success: ${result.success}, Formation Steps: ${result.executedSteps}`);
        });
    });
    ...
    describe('Performance and Stress Testing', () => {
        test('should handle extended gameplay session', async () => {
            ...
            console.log(`Extended Session - Success: ${result.success}, Total Actions: ${result.executedSteps}, Avg Time: ${result.performance.averageStepTime.toFixed(2)}ms`);
        });
        ...
        test('should maintain performance under stress', async () => {
            ...
            console.log(`Stress Test - Success: ${result.success}, Actions: ${result.executedSteps}, Errors: ${result.errors.length}`);
        });
    });
    ...
    describe('Accessibility Scenarios', () => {
        test('should support screen reader workflow', async () => {
            ...
            console.log(`Screen Reader Support - Success: ${result.success}, Keyboard Only: ${result.stepResults.every(s => s.stepType === 'key')}`);
        });
        ...
        test('should support motor accessibility workflow', async () => {
            ...
            console.log(`Motor Accessibility - Success: ${result.success}, Wait Steps: ${waitSteps.length}`);
        });
    });
});