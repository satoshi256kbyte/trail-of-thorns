...
export class BattleBalanceTool {
  ...
  private updateStatistics(): void {
    ...
    this.statistics.criticalHitRate =
      (this.statistics.criticalHits / this.statistics.totalBattles) * 100;
    this.statistics.hitRate =
      ((this.statistics.totalBattles - this.statistics.missedAttacks) /
        this.statistics.totalBattles) *
      100;
