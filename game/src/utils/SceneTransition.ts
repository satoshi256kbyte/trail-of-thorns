...
export class SceneTransition {
  ...
  public static transitionTo(
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        console.log(
          `Starting transition from ${fromScene.scene.key} to ${toSceneKey} with ${transitionType}`
        );
  ...
  public static fadeToScene(
    ...
    return this.transitionTo(fromScene, toSceneKey, TransitionType.FADE, sceneData, { duration });
  }
