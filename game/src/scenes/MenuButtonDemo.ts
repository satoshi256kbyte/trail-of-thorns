...
export class MenuButtonDemo extends Phaser.Scene {
  ...
  create(): void {
    ...
    // Add instructions
    this.add
      .text(400, 500, 'Hover and click the buttons to test interactions', {
        fontSize: '16px',
        fontFamily: 'Arial',
        color: '#cccccc',
      })
  ...
  private createDemoButtons(): void {
    // Standard button
    const standardButton = new MenuButton(this, 200, 200, 'Standard Button', () => {
    ...
    let isEnabled = true;
    const toggleButton = new MenuButton(this, 200, 300, 'Toggle Me', () => {
      isEnabled = !isEnabled;
    ...
    let clickCount = 0;
    const counterButton = new MenuButton(this, 600, 300, 'Click Count: 0', () => {
      clickCount++;
    ...
    // Exit button
    const exitButton = new MenuButton(this, 400, 400, 'Back to Game', () => {
