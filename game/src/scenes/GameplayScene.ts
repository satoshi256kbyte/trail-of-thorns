...
import { StageData, MapData, Unit, GameplayError, GameplayErrorResult, TypeValidators } from '../types/gameplay';
...
export class GameplayScene extends Phaser.Scene {
    ...
    private handleEscape(): void {
        // Deselect current unit or show pause menu
    ...
    private showPauseMenu(): void {
        ...
        // Pause title
        const pauseTitle = this.add.text(0, -120, 'Game Paused', {
            fontSize: '36px',
            color: '#ffffff',
            fontFamily: 'Arial',
            fontStyle: 'bold'
        ...
        const returnToStageSelectButton = this.createPauseMenuButton(0, 20, 'Return to Stage Select', () => {
            this.hidePauseMenu();
     ...
     */
    private createPauseMenuButton(x: number, y: number, text: string, callback: () => void): Phaser.GameObjects.Container {
