...
import { Weapon, TargetSelectionResult, BattleError, BattleErrorDetails, BattleContext } from '../types/battle';
...
export class TargetSelector {
    ...
    public canTargetUnit(target: Unit): boolean {
        ...
        return this.selectionState.validTargets.some(
            validTarget => validTarget.id === target.id
        );
    }
     ...
     */
    public getOptimalTarget(criteria: 'nearest' | 'weakest' | 'strongest' | 'random' = 'nearest'): Unit | null {
