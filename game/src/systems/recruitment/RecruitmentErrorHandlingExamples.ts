...
export class BasicRecruitmentErrorHandlingExample {
    ...
    private setupErrorEventListeners(): void {
        ...
        this.eventEmitter.on('recruitment-error-handled', (data: {
        ...
        this.eventEmitter.on('recruitment-cancel-requested', (data: {
            error: RecruitmentError;
            context: RecruitmentContext;
        }) => {
        ...
        this.eventEmitter.on('recruitment-reset-requested', (data: {
            error: RecruitmentError;
            context: RecruitmentContext;
        }) => {
        ...
        this.eventEmitter.on('recruitment-cleanup-requested', (data: {
            error: RecruitmentError;
            context: RecruitmentContext;
        }) => {
    ...
    private handleInvalidTargetError(context: RecruitmentContext, recovery: RecruitmentErrorRecoveryResult): void {
    ...
    private handleConditionsNotMetError(context: RecruitmentContext, recovery: RecruitmentErrorRecoveryResult): void {
    ...
    private handleNPCDefeatedError(context: RecruitmentContext, recovery: RecruitmentErrorRecoveryResult): void {
...
export class RecruitmentErrorMonitoringExample {
    ...
    private setupErrorMonitoring(): void {
        ...
        this.errorHandler.on('recruitment-error-handled', (data: {
            error: RecruitmentError;
            context: RecruitmentContext;
            recoveryResult: RecruitmentErrorRecoveryResult;
        }) => {
    ...
    private analyzeErrorTrends(): void {
        ...
        const affectedUsers = Array.from(this.errorAnalytics.userImpact.entries())
    ...
    private alertHighErrorRate(recentErrors: Array<{
        timestamp: number;
        error: RecruitmentError;
        context: string;
    }>): void {
    ...
    generateErrorReport(): {
        ...
        const recoveryRate = stats.totalErrors > 0
            ? (stats.recoveredErrors / stats.totalErrors) * 100
            : 100;
...
export class CustomRecruitmentErrorRecoveryExample {
    ...
    private async handleTutorialConditionsNotMet(context: RecruitmentContext): Promise<RecruitmentErrorRecoveryResult> {
    ...
    private async handleTutorialInvalidTarget(context: RecruitmentContext): Promise<RecruitmentErrorRecoveryResult> {
