...
export class OptimizedNPCStateManager extends NPCStateManager {
  ...
  constructor(scene?: Phaser.Scene, config?: any, eventEmitter?: Phaser.Events.EventEmitter) {
  ...
  private updateMetrics(): void {
    ...
    this.metrics.poolEfficiency =
      totalPoolRequests > 0 ? this.statePool.stats.poolHits / totalPoolRequests : 0;
