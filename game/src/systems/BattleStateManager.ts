...
export class BattleStateManager {
    ...
    constructor(
        ...
        this.experienceConfig = { ...BattleStateManager.DEFAULT_EXPERIENCE_CONFIG, ...experienceConfig };
     ...
     * @returns GameplayErrorResult indicating success or failure
     */
    grantExperience(unit: Unit, baseAmount: number, battleResult?: BattleResult): GameplayErrorResult {
        try {
            // Validate inputs
            if (!unit) {
                return {
            ...
            if (battleResult) {
                ...
                const levelMultiplier = 1 + (levelDifference * this.experienceConfig.levelDifferenceMultiplier);
