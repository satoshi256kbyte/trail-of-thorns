...
export class TypeValidators {
    ...
    static isValidMapLayer(layer: any): layer is MapLayer {
        return (
            ...
            layer.data.every((row: any) => Array.isArray(row) && row.every((cell: any) => typeof cell === 'number')) &&
    ...
    static isValidVictoryCondition(condition: any): condition is VictoryCondition {
        ...
        return (
            ...
            (condition.turns === undefined || (typeof condition.turns === 'number' && condition.turns > 0))
        );
    }
    ...
    static isValidStageData(stageData: any): stageData is StageData {
        return (
            ...
            stageData.victoryConditions.every((condition: any) => this.isValidVictoryCondition(condition)) &&
            (stageData.defeatConditions === undefined ||
                (Array.isArray(stageData.defeatConditions) &&
                    stageData.defeatConditions.every((condition: any) => this.isValidVictoryCondition(condition))))
        );
    }
    ...
    static isValidGameState(gameState: any): gameState is GameState {
        ...
        return (
            ...
            (gameState.gameResult === null || gameState.gameResult === 'victory' || gameState.gameResult === 'defeat') &&
