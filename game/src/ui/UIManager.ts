...
export class UIManager {
    ...
    private createBattleStatusPanel(): void {
        ...
        // Status text
        this.uiElements.battleStatusText = this.scene.add.text(
            panelWidth / 2,
            panelHeight / 2,
            'Battle Phase',
            {
    ...
    public showExperienceGained(x: number, y: number, experience: number): void {
        ...
        const expText = this.scene.add.text(x, y, `+${experience} EXP`, {
            fontSize: '16px',
            color: '#44ff44',
            fontFamily: 'Arial',
            stroke: '#000000',
    ...
    public showBattleResult(result: BattleResultDisplay): void {
        ...
        // Title
        const title = this.scene.add.text(panelWidth / 2, 30, 'Battle Result', {
            fontSize: '24px',
            color: '#ffffff',
            fontFamily: 'Arial',
            fontStyle: 'bold',
        ...
        const details = this.scene.add.text(panelWidth / 2, 100, resultText, {
            fontSize: '16px',
            color: '#cccccc',
            fontFamily: 'Arial',
            align: 'center',
        ...
        // Close button
        const closeButton = this.scene.add.text(panelWidth / 2, 160, 'Continue', {
            fontSize: '18px',
            color: '#ffffff',
            fontFamily: 'Arial',
    ...
    public showErrorNotification(data: ErrorNotificationData): void {
        ...
        // Message text
        const messageText = this.scene.add.text(panelWidth / 2, panelHeight / 2, data.message, {
            fontSize: '16px',
            color: '#ffffff',
            fontFamily: 'Arial',
            align: 'center',
