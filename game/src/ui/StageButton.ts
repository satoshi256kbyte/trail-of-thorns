...
export class StageButton extends Phaser.GameObjects.Container {
    ...
    private createButton(): void {
        ...
        this.background.setStrokeStyle(
            StageButton.CONFIG.borderWidth,
            this.getBorderColor()
        );
        ...
        this.nameText = this.scene.add.text(0, -40, this.stage.name, {
            fontSize: '20px',
            color: '#ffffff',
            fontFamily: 'Arial',
            fontStyle: 'bold',
        ...
        this.descriptionText = this.scene.add.text(0, -10, this.stage.description, {
            fontSize: '14px',
            color: '#ecf0f1',
            fontFamily: 'Arial',
            align: 'center',
        ...
        this.difficultyText = this.scene.add.text(0, 30, `Difficulty: ${difficultyStars}`, {
            fontSize: '16px',
        ...
        if (!this.stage.isUnlocked) {
            this.lockIndicator = this.scene.add.text(0, 50, '🔒 LOCKED', {
                fontSize: '14px',
                color: '#e74c3c',
                fontFamily: 'Arial',
                fontStyle: 'bold',
    ...
    private onHover(): void {
        ...
        this.background.setStrokeStyle(
            StageButton.CONFIG.borderWidth + 1,
            0x5dade2
        );
    }
